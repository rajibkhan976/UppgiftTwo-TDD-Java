...
public class PurchaseManagerTests {
    ...
    public void  testmonthlyAverage () {
        ...
        storeStub.addPurchases(9, LocalDate.of(2020,10,1), LocalDate.of(2020,10,30), 4500.0, "Furniture bfbn", 6);
        storeStub.addPurchases(7, LocalDate.of(2020,11,1), LocalDate.of(2020,11,30), 3000.0, "Vegetables dsb", 4);
        storeStub.addPurchases(11, LocalDate.of(2020,12,1), LocalDate.of(2020,12,30), 6000.0, "Electronics bdb", 5);
